                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="rounded-xl border border-surface-200 bg-surface-100 px-4 py-3 text-sm text-slate-600">
                          <p className="font-semibold text-slate-800">Datos para el deposito</p>
                          <p>Banco: {bankConfig.name}</p>
                          <p>Cuenta: {bankConfig.account}</p>
                          <p>Titular: {bankConfig.owner}</p>
                          {bankConfig.document && <p>Identificacion: {bankConfig.document}</p>}
                        </div>
