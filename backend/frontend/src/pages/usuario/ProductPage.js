...
const ProductPage = () => {
  ...
  const headingTitle = searchTerm ? `Resultados para "${searchTerm}"` : 'Inventario activo';
      ...
      <div className="container mx-auto px-4 py-8 lg:px-10">
        <div className="flex flex-col gap-3 border-b border-surface-200 pb-6">
          ...
          <p className="max-w-3xl text-sm text-slate-500">
            Gestiona tu catalogo, registra pedidos y controla existencias en tiempo real. Usa la busqueda
            superior para filtrar por nombre, codigo o SKU.
          </p>
              ...
              <div key={product._id} className="surface-card overflow-hidden">
                ...
                <div className="space-y-5 p-6">
                  ...
                  <div className="flex items-center justify-between text-sm font-semibold text-brand">
                    ...
                    <a href={`/product/${product._id}`} className="hover:text-brand-dark">
                      Ver producto
                    </a>
                  </div>
                </div>
